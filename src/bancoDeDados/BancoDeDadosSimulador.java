...
public class BancoDeDadosSimulador {
    ...
    public static Usuario usuario1 = new Usuario("admin", "1234", null, null);
    public static Usuario usuario2 = new Usuario("empresa", "1234", null, empresa);
    public static Usuario usuario3 = new Usuario("cliente", "1234", cliente, null);
    public static Usuario usuario4 = new Usuario("cliente2", "1234", cliente2, null);
    public static Usuario usuario5 = new Usuario("empresa2", "1234", null, empresa2);
    public static Usuario usuario6 = new Usuario("empresa3", "1234", null, empresa3);
